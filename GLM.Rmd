...
lichens_dat  <- read.csv("www/lichen.csv")
...
and make predictions from that. Run the code below to see this. Note the addition
of the `

```{r lichen_fit_and_plot, exercise=TRUE}
# You can use the update function to simplify the model
# give it the name of the original model
# then . ~ . to indicate the same response and explanatories
# finally -airpoll to remove the airpoll variable
lichen_calcium_glm <- update(lichen_glm2, . ~ . -airpoll)
plotModel(lichen_calcium_glm)
```
